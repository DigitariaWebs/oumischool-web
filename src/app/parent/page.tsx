        ...
        <div className="border-b border-border/50 bg-gradient-to-r from-primary/5 to-transparent px-4 py-8 md:px-6 md:py-12">
          <div className="max-w-5xl">
            ...
            <p className="mt-3 text-lg text-gray-700">
              Suivi pédagogique de vos enfants
            </p>
          </div>
        </div>
        ...
        <div className="px-4 py-12 md:px-6">
          <div className="max-w-5xl">
            ...
            <div className="mt-12 max-w-lg rounded-2xl border border-border bg-card p-6">
              <h3 className="text-xl font-semibold">Espace parent</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Le portail parent web sera enrichi progressivement. Vous êtes
                bien connecté avec un profil parent.
              </p>
            </div>
          </div>
        </div>
